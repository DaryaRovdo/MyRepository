...
public class Solving {
    protected ArrayList<Juice> getJuices(ArrayList <ArrayList <String>> data) {
    ...
    protected ArrayList <String> getComponents (ArrayList <ArrayList <String>> data) {
    ...
    protected ArrayList <String> getUniqueComponents (ArrayList <String> components) throws InterruptedException {
    ...
    protected TreeMap <String, Integer> getComponentsAmount(ArrayList <String> components) {
    ...
    protected int washAmount(ArrayList <Juice> juices, TreeMap <String, Integer> componentsAmount) {
        int amount = 0;
